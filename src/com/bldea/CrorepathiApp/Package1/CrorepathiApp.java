...
public class CrorepathiApp {
	public static void main(String[] args)throws Exception {
		...
		System.out.println("1.There will be 10 question which rewards a speccific amount in incremental order");
		...
		System.out.println("Please type 1 if you wish to see the reward per question.else try");
